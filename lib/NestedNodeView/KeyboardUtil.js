define(["require", "exports"], function (require, exports) {
    ...
    var _KeyMods = [];
    for (var mod in exports.KeyMod) {
        exports.KeyMod.hasOwnProperty(mod) && _KeyMods.push(exports.KeyMod[mod]);
    }
    var Shortcut = (function () {
        function Shortcut(keyEvent) {
            this.keyEvent = keyEvent;
        }
        Shortcut.prototype.eq = function (keyCode) {
            var _this = this;
            var mods = [];
            ...
            return _KeyMods.reduce(function (res, mod) {
                var modRequired = mods.indexOf(mod) != -1;
                return res && (modRequired ? _this.keyEvent[mod] : !_this.keyEvent[mod]);
            }, true);
        };
        return Shortcut;
    })();
