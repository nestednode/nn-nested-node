...
define(["require", "exports", 'pkg/React/React', '../NestedNodeProps/SelectionMode', './NestedNodeView', './KeyboardUtil'], function (require, exports, React, SelectionMode, NestedNodeView, KeyboardUtil) {
    var dom = React.DOM;
    ...
    (function (NNDocumentView) {
        var Component = (function (_super) {
            ...
            Component.prototype.render = function () {
                ...
                return (dom['div']({ className: 'nn' + stringifyMods('nn', this.props.styleMods) }, dom['div']({ className: 'nn__doc-scrollbox' }, dom['div']({ ref: 'wrapper', className: 'nn__doc-wrapper' }, dom['div']({
