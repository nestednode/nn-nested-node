...
define(["require", "exports", 'pkg/Collection/Collection', 'pkg/EventEmitter/EventEmitter', './NestedNode', './Direction', './SelectionMode', './SelectionHelper', './CommandHistory', './Command/UpdateDataCommand', './Command/AppendCommand', './Command/EnvelopeCommand', './Command/RemoveCommand', './Command/RearrangeCommand', './Command/CompositeCommand'], function (require, exports, Collection, EventEmitter, NestedNode, Direction, SelectionMode, SelectionHelper, CommandHistory, UpdateDataCommand, AppendCommand, EnvelopeCommand, RemoveCommand, RearrangeCommand, CompositeCommand) {
    var NNDocument = (function (_super) {
        ...
        NNDocument.prototype.enterEditMode = function (emitModeChange) {
        ...
        NNDocument.prototype.exitEditMode = function (emitModeChange) {
            if (emitModeChange === void 0) { emitModeChange = true; }
            if (!this._editMode) {
        ...
        NNDocument.prototype.executeCommand = function (cmd) {
