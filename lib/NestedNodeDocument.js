...
define(["require", "exports", 'pkg/Collection/Collection', 'pkg/EventEmitter/EventEmitter', './NestedNode', './Direction', './SelectionMode', './SelectionHelper', './Command/CommandHistory', './Command/AppendCommand', './Command/EnvelopeCommand', './Command/RemoveCommand', './Command/RearrangeCommand', './Command/CompositeCommand'], function (require, exports, Collection, EventEmitter, NestedNode, Direction, SelectionMode, SelectionHelper, CommandHistory, AppendCommand, EnvelopeCommand, RemoveCommand, RearrangeCommand, CompositeCommand) {
    var NestedNodeDocument = (function (_super) {
        ...
        Object.defineProperty(NestedNodeDocument.prototype, "node", {
        ...
        Object.defineProperty(NestedNodeDocument.prototype, "editMode", {
            get: function () {
        ...
        NestedNodeDocument.prototype.enterEditMode = function () {
            if (this._editMode) {
        ...
        NestedNodeDocument.prototype.exitEditMode = function () {
            if (!this._editMode) {
