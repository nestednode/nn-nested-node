...
define(["require", "exports", 'pkg/Collection/Collection', 'pkg/EventEmitter/EventEmitter', './NestedNode', './Direction', './SelectionMode', './SelectionHelper', './Command/CommandHistory', './Command/AppendCommand', './Command/EnvelopeCommand', './Command/RemoveCommand', './Command/RearrangeCommand', './Command/CompositeCommand', './Command/PreserveFocusCommand'], function (require, exports, Collection, EventEmitter, NestedNode, Direction, SelectionMode, SelectionHelper, CommandHistory, AppendCommand, EnvelopeCommand, RemoveCommand, RearrangeCommand, CompositeCommand, PreserveFocusCommand) {
    var NestedNodeDocument = (function (_super) {
        __extends(NestedNodeDocument, _super);
        // * Constructing
        function NestedNodeDocument(data, clipboardProvider) {
            var _this = this;
            _super.call(this);
            ...
            this.root = new NestedNode(this, {}, function (d) { return d; });
            var topNode = new NestedNode(this, data, this.nodeFieldDuplicator);
        ...
        NestedNodeDocument.prototype.nodeFieldDuplicator = function (data) {
            throw new Error('abstract method');
        };
        ...
        NestedNodeDocument.prototype.getPreviouslyFocusedNested = function (parentNode) {
        ...
        NestedNodeDocument.prototype.appendNewNode = function (direction) {
            ...
            if (this.focusedNode.isTopLevel) {
                ...
                command = new CompositeCommand([
                    new PreserveFocusCommand(this.focusedNode),
        ...
        NestedNodeDocument.prototype.envelopeNode = function () {
        ...
        NestedNodeDocument.prototype.copyToClipboard = function () {
            var _this = this;
            var data = this.root.getSelection().map(function (node) { return node.cloneData(_this.nodeFieldDuplicator); });
            this.clipboard.set(data);
        };
        NestedNodeDocument.prototype.cutToClipboard = function () {
            this.copyToClipboard();
            this.removeNode();
        };
        NestedNodeDocument.prototype.pasteFromClipboard = function () {
            var _this = this;
            ...
            var nodesToPaste = data.map(function (d) { return new NestedNode(_this, d, _this.nodeFieldDuplicator); });
            // todo
    ...
    var LocalClipboardProvider = (function () {
        ...
        LocalClipboardProvider.prototype.set = function (data) {
