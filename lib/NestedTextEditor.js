...
define(["require", "exports", './NNDocument', './NNDocumentView', './NestedNodeView', './KeyboardUtil', 'pkg/React/React'], function (require, exports, NNDocument, NNDocumentView, NestedNodeView, KeyboardUtil, React) {
    var dom = React.DOM;
