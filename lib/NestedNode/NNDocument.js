...
define(["require", "exports", 'bower_components/nn-collection/Collection', 'bower_components/nn-emitter/EventEmitter', '../NestedNodeProps/SelectionMode', './NestedNode', './Direction', './SelectionHelper', './CommandHistory', './Command/UpdateDataCommand', './Command/AppendCommand', './Command/EnvelopeCommand', './Command/DuplicateCommand', './Command/RemoveCommand', './Command/RearrangeCommand', './Command/CompositeCommand'], function (require, exports, Collection, EventEmitter, SelectionMode, NestedNode, Direction, SelectionHelper, CommandHistory, UpdateDataCommand, AppendCommand, EnvelopeCommand, DuplicateCommand, RemoveCommand, RearrangeCommand, CompositeCommand) {
    var NNDocument = (function (_super) {
        __extends(NNDocument, _super);
        // * Constructing
        function NNDocument(content, dataFunctions, clipboardProvider) {
            var _this = this;
            _super.call(this);
        ...
        Object.defineProperty(NNDocument.prototype, "content", {
        ...
        NNDocument.prototype.createNode = function (props) {
            ...
            return new NestedNode(this, props, this.dataFunctions.duplicate);
        };
        ...
        NNDocument.prototype.enterEditMode = function (newData, emitModeChange) {
        ...
        NNDocument.prototype.duplicateNode = function () {
            ...
            var selection = SelectionHelper.getSelectionNearNode(this.focusedNode);
            var duplicatedNodes = selection.map(function (node) { return _this.createNode(node); });
        ...
        NNDocument.prototype.copyToClipboard = function () {
            var _this = this;
            var nodesProps = this.root.getSelection().map(function (node) { return node.cloneProps(_this.dataFunctions.duplicate); });
