define(["require", "exports", './Direction'], function (require, exports, Direction) {
    ...
    function extendSelectionToNodeSiblings(node) {
        var result;
        node.parent.nested.forEach(function (sibling) { return result = sibling.unselectDeep().select(); });
        return result;
    }
    exports.extendSelectionToNodeSiblings = extendSelectionToNodeSiblings;
