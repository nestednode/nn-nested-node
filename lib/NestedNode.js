define(["require", "exports", './Direction'], function (require, exports, Direction) {
    var NestedNode = (function () {
        // * Constructing
        function NestedNode(registry, data, fieldDuplicator) {
            var _this = this;
            ...
            this._nested = data.nested ? data.nested.map(function (nestedData) {
                ...
                var nested = new NestedNode(registry, nestedData, fieldDuplicator);
        ...
        NestedNode.prototype.cloneData = function (fieldDuplicator) {
            var result = fieldDuplicator(this.data);
            result.nested = this.mapNested(function (nestedNode) { return nestedNode.cloneData(fieldDuplicator); });
            return result;
        };
        return NestedNode;
    })();
